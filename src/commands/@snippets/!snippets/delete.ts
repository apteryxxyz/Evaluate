...
import { buildDeleteButton } from '@lib/util/snippetHelpers';
...
export default class DeleteSnippet extends Command {
    public constructor() {
        super({
            type: Command.Type.ChatInput,
            kinds: [Command.Kind.Slash],
            name: 'delete',
            description: 'Delete one of your code snippets.',
    ...
    public override async onChatInput(interaction: Command.ChatInput): Promise<void> {
        ...
        const button = buildDeleteButton(snippet._id.toString(), true);
